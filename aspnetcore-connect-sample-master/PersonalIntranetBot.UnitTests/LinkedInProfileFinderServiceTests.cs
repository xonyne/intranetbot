...
namespace PersonalIntranetBot.UnitTests
{
    ...
    public class LinkedInProfileFinderServiceTests
    {
        ...
        public void GetLinkedInProfileURLFromNameAndCompany_NameAndCompanyMatchingProfileFound_ReturnsCorrectProfile()
        {
            ...
            string searchString = String.Join(" ", new[] { NAME, COMPANY, LinkedInProfileFinderService.LINKEDIN_SEARCH_SUFFIX });
            ...
            // Act
            string resultString = LinkedInProfileFinderService.GetLinkedInProfileURLFromNameAndCompany(NAME, COMPANY);
